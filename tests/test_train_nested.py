...
if __name__ == '__main__':   
    ...
    args = get_args(args_list + '--train-data fake --num-workers 0 --save ./checkpoints/test_train_nested --train-iters 500'.split()
    )
    args = argparse.Namespace(**vars(args), **vars(known))
    
    training_main(args, model_cls=NestedModel, forward_step_function=forward_step, create_dataset_function=create_dataset_function)
